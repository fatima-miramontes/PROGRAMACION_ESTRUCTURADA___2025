...
"""
  Una función es un conjunto de instrucciones agrupadas bajo un nombre en particular como un programa más pequeño que cumple una función especifica. La función se puede reutulizar con el simple hecho de invocarla es decir mandarla llamar 
